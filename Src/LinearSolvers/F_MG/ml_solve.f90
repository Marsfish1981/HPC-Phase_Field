...
contains
  ...
  subroutine ml_cc_solve_1(mla,rh,full_soln,&!fine_flx,
                           alpha,beta,dx,the_bc_tower,bc_comp, &
    ...
    call ml_cc_solve(mla, mgt, rh, full_soln, &!fine_flx, 
                     do_diagnostics_loc)
  ...
  subroutine ml_cc_solve_2(mla,mgt,rh,full_soln,&!fine_flx,
                           do_diagnostics)
